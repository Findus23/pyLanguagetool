...
complete -c pylanguagetool -s P -l api-key -d 'For languagetool.org Premium API.'
complete -c pylanguagetool -s U -l username -d 'For languagetool.org Premium API. Your username/email as used to log in at languagetool.org'
